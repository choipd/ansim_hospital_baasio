...
{    
    ...
    NSLog(@"datum: %@", self.datum);
    cell.textLabel.text = [[self.datum allKeys] objectAtIndex:indexPath.row];
    cell.detailTextLabel.text = [[[self.datum allValues] objectAtIndex:indexPath.row] description];
